...
st.set_page_config(
    page_title="11890 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - 11890</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'C:\Users\Acer\Downloads\Unsupervised Learning (Praktek)\Unsupervised Learning (Praktek)\Tugas4_X_YYYYY'
    model_path = {
